...
const ContactInfoComponent: React.FC<ContactInfoProps> = ({ contactInfo }) => {
        ...
        return (
          <p key={entry.id} className="contact-info-item">
            ...
            <a
              ...
              aria-label={t('contactInfo.ariaEmail', { value: entry.value })}
            >
              {entry.value}
            </a>
          </p>
        ...
        return (
          <p key={entry.id} className="contact-info-item">
            ...
            <a
              ...
              aria-label={t('contactInfo.ariaPhone', { value: entry.value })}
            >
              {entry.value}
            </a>
          </p>
        ...
        return (
          <p key={entry.id} className="contact-info-item">
            ...
            >
              ...
              <span className="contact-link-url">
        ...
        return (
          <p key={entry.id} className="contact-info-item contact-info-item--social">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label={t('contactInfo.ariaGithub', { value: entry.value })}
            >
        ...
        return (
          <p key={entry.id} className="contact-info-item contact-info-item--social">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label={t('contactInfo.ariaLinkedin', { value: entry.value })}
            >
  ...
  return <div className="contact-info">{contactInfo.map(renderEntry)}</div>;
};
